...
Java_com_snail_device_jni_PropertiesGet_native_1get__Ljava_lang_String_2Ljava_lang_String_2
...
JNIEXPORT jstring JNICALL
Java_com_snail_device_jni_PropertiesGet_native_1get__Ljava_lang_String_2
        (JNIEnv *env, jclass clazz, jstring keyJ) {
    return Java_com_snail_device_jni_PropertiesGet_native_1get__Ljava_lang_String_2Ljava_lang_String_2(
            env, clazz, keyJ, NULL);
}
